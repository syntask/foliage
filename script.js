...
// -----------------------------MATERIALS--------------------------------------------------------------------------------------------------------------------------------------
    ...
    const textureUrls = {
      steelCortenAlbedo: "assets/textures/steelCorten/steelCorten_albedo.png",
      steelCortenMetallic: "assets/textures/steelCorten/steelCorten_metallic.png",
      steelCortenAO: "assets/textures/steelCorten/steelCorten_ao.png",
      steelCortenRoughness: "assets/textures/steelCorten/steelCorten_roughness.png",
      steelCortenNormal: "assets/textures/steelCorten/steelCorten_normal.png",
      steelCortenHeight: "assets/textures/steelCorten/steelCorten_height.png",
      steelStainlessBrushedAlbedo: "assets/textures/steelStainlessBrushed/steelStainlessBrushed_albedo.png",
      steelStainlessBrushedMetallic: "assets/textures/steelStainlessBrushed/steelStainlessBrushed_metallic.png",
      steelStainlessBrushedRoughness: "assets/textures/steelStainlessBrushed/steelStainlessBrushed_roughness.png",
      steelStainlessBrushedNormal: "assets/textures/steelStainlessBrushed/steelStainlessBrushed_normal.png",
      steelGalvanizedAlbedo: "assets/textures/steelGalvanized/steelGalvanized_albedo.png",
      steelGalvanizedMetallic: "assets/textures/steelGalvanized/steelGalvanized_metallic.png",
      steelGalvanizedRoughness: "assets/textures/steelGalvanized/steelGalvanized_roughness.png",
      steelGalvanizedNormal: "assets/textures/steelGalvanized/steelGalvanized_normal.png",
    };
    ...
    Object.entries(textureUrls).forEach(([key, url]) => {
      loadAndConfigureTexture(url, (texture) => {
    ...
    const loader = new THREE.TextureLoader();
    loader.load('assets/textures/env/env.jpg', function(texture) {
    ...
    pointLight3.position.set(40, 60, -40);
    ...
    // Ceiling light 4
    const pointLight4 = new THREE.PointLight(0xffffff, 3, 100);
    pointLight4.position.set(-40, 60, 40);
    ...
    // Sun at dusk
    const directionalLight = new THREE.DirectionalLight(0xFFCCAA, .5);
    directionalLight.position.set(70, -10, 0);
    ...
    function updateModel() {
      ...
      // Rear 
      createWall(
        materials.steelStainlessBrushedDark,
        length - thickness,
        latSuppW,
        latSuppH,
