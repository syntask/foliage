    ...
    Object.entries(textureUrls).forEach(([key, url]) => {
      ...
      loadAndConfigureTexture(uniqueUrl, (texture) => {
        ...
        if (texturesLoaded === totalTextures) {
          ...
          // Remove the loading animation now that everything is initialized
          // Get a reference to the element with id 'loadingDiv'
          ...
          if (elementToRemove) {
              ...
              console.log("Element with id 'loadingDiv' not found.");
          }
