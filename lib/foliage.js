...
// -----------------------------MATERIALS--------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Ceiling light 1
    const pointLight1 = new THREE.PointLight(0xffffff, .5, 200);
    ...
    // Ceiling light 2
    const pointLight2 = new THREE.DirectionalLight(0xffffff, .15, 200);
    ...
    // Ceiling light 3
    const pointLight3 = new THREE.DirectionalLight(0xffffff, .15, 200);
    ...
    // Ceiling light 4
    const pointLight4 = new THREE.DirectionalLight(0xffffff, .15, 200);
    ...
    // Ceiling light 5
    const pointLight5 = new THREE.DirectionalLight(0xffffff, .25, 200);
    ...
    // Sun at dusk
    const directionalLight2 = new THREE.DirectionalLight(0xFFCCAA, .33);
    ...
    // Sun at dusk
    const directionalLight = new THREE.DirectionalLight(0xFFCCAA, .15);
