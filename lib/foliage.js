...
// -----------------------------MATERIALS--------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Ceiling light 1
    const pointLight1 = new THREE.PointLight(0xffffff, .75, 200);
    ...
    // Ceiling light 2
    const pointLight2 = new THREE.DirectionalLight(0xffffff, .23, 200);
    ...
    // Ceiling light 3
    const pointLight3 = new THREE.DirectionalLight(0xffffff, .23, 200);
    ...
    // Ceiling light 4
    const pointLight4 = new THREE.DirectionalLight(0xffffff, .23, 200);
    ...
    // Ceiling light 5
    const pointLight5 = new THREE.DirectionalLight(0xffffff, .23, 200);
    ...
    // Sun at dusk
    const directionalLight2 = new THREE.DirectionalLight(0xFFCCAA, .5);
    ...
    // Sun at dusk
    const directionalLight = new THREE.DirectionalLight(0xFFCCAA, .23);
    directionalLight.position.set(70, -20, 0);
